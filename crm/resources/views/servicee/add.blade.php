    ...
    <h3> <a href="list">客户服务日常安排</a> <a href="">新建客户服务记录</a> </h3>
        <table >
            ...
            <tr>
                ...
                <td></td>
                <td  class="td">联系人：</td>
                <td><input type="text" name="service_tel" id="service_tel"></td>
            </tr>
            <tr>
                <td class="td">服务成本：</td>
            ...
            <tr>
                ...
                <td  colspan="4">
                    <textarea name="service_text" id="" cols="70" rows="6" id="service_text"></textarea>
                </td>
            </tr>
            </tr>
                <td  >
            ...
            <tr>
                ...
                <td colspan="4"><input type="text"  name="service_satisfied"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="td">备注1：</td>
                <td  colspan="4">
                    <textarea name="service_remarks1" id="" cols="70" rows="6"></textarea>
                </td>
            </tr>
            <tr>
                <td class="td">备注2：</td>
                <td  colspan="4">
                    <textarea name="service_remarks2" id="" cols="70" rows="6"></textarea>
                </td>
            </tr>
            <tr >
